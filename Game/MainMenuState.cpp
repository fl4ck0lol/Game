...
void MainMenuState::IntitialiseButtons()
{
	...
	buttonSize_x = 260;
	buttonSize_y = 80;
	this->buttons["GAME_STATE"] = new Button(centerButtons(buttonSize_x), 350, buttonSize_x, buttonSize_y, L"НОВА ИГРА", sf::Color(52, 61, 70, 50), &this->font,
	...
	this->buttons["SETTINGS"] = new Button(centerButtons(buttonSize_x), 500, buttonSize_x, buttonSize_y, L"НАСТРОЙКИ", sf::Color(52, 61, 70, 50), &this->font,
		sf::Color(192, 197, 206, 0), sf::Color(101, 115, 126, 0), sf::Color(52, 61, 70, 0), 50,
		sf::Color(107, 36, 12, 250), sf::Color(245, 204, 160, 255), sf::Color(52, 61, 70, 200), sf::Color::Transparent, 0);

	this->buttons["EDITOR"] = new Button(centerButtons(buttonSize_x), 650, buttonSize_x, buttonSize_y, L"EDITOR", sf::Color(52, 61, 70, 50), &this->font,
		sf::Color(192, 197, 206, 0), sf::Color(101, 115, 126, 0), sf::Color(52, 61, 70, 0), 50,
		sf::Color(107, 36, 12, 250), sf::Color(245, 204, 160, 255), sf::Color(52, 61, 70, 200), sf::Color::Transparent, 0);
	
	this->buttons["END_STATE"] = new Button(centerButtons(buttonSize_x), 800, buttonSize_x, buttonSize_y, L"ИЗХОД", sf::Color(52, 61, 70, 50), &this->font,
		sf::Color(192, 197, 206, 0), sf::Color(101, 115, 126, 0), sf::Color(52, 61, 70, 0), 50,
		sf::Color(107, 36, 12, 250), sf::Color(245, 204, 160, 255), sf::Color(52, 61, 70, 200), sf::Color::Transparent, 0);
}
...
void MainMenuState::InitialiseBackGround()
{
	...
	this->container.setSize(sf::Vector2f(static_cast<float>(this->window->getSize().x), 200));
	this->container.setPosition(sf::Vector2f(
		static_cast<float>((this->window->getSize().x / 2) - (container.getSize().x / 2)),
...
void MainMenuState::updateButtons()
{
	...
	this->buttons["GAME_STATE"]->updatePosition(centerButtons(260), 350);
	this->buttons["SETTINGS"]->updatePosition(centerButtons(260), 500);
	this->buttons["EDITOR"]->updatePosition(centerButtons(260), 650);
	this->buttons["END_STATE"]->updatePosition(centerButtons(260), 800);
}
